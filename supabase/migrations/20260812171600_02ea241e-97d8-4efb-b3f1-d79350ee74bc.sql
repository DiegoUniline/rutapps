ALTER TABLE public.comision_esquemas DROP CONSTRAINT IF EXISTS comision_esquemas_tipo_check;
ALTER TABLE public.comision_esquemas ADD CONSTRAINT comision_esquemas_tipo_check
  CHECK (tipo IN ('volumen_pct','volumen_tiers','bono_meta','lista_precios'));
...
BEGIN
  ...
  ELSIF v_esquema.tipo = 'lista_precios' THEN
    -- Comisión tomada de las reglas de listas de precios (venta_comisiones por línea)
