...
export const CLIENTE_COLUMNS = [
  ...
  'facturama_uso_cfdi','facturama_cp','facturama_direccion_fiscal','facturama_forma_pago',
  'facturama_correo_facturacion','notas_fiscales','created_at',
] as const;
...
export const PRODUCTO_COLUMNS = [
  ...
  'es_granel','unidad_granel','maneja_lote',
