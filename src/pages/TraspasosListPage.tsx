              ...
              <>
                <tr
                  ...
                  className={cn(
                    ...
                    isExpanded ? "bg-primary/5" : selected.has(t.id) ? "bg-primary/5" : "hover:bg-table-hover"
                  )}
                ...
                {isExpanded && (
                  <TraspasoExpandedRow
                    ...
                    traspaso={t}
                    colSpan={8}
                    origenLabel={getOrigenLabel(t)}
                    destinoLabel={getDestinoLabel(t)}
                    tipoLabel={TIPO_LABELS[t.tipo] || t.tipo}
        ...
        {items.length > 0 && (
          <tfoot>
            <tr className="bg-card border-t border-border font-semibold text-[12px]">
              <td colSpan={8} className="py-2 px-3 text-muted-foreground">{items.length} traspasos</td>
            </tr>
          </tfoot>
        )}
      </table>
