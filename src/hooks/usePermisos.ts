...
export const MODULOS_MOVIL: ModuloMovilDef[] = [
  ...
  { id: 'ruta.ventas', label: 'Ventas (pestaña principal)', group: 'Vistas', description: 'Pestaña inferior/tab superior "Ventas"' },
  { id: 'ruta.ventas_hist', label: 'Ventas (historial)', group: 'Vistas', description: 'Sub-pestaña de historial dentro de Ventas' },
  { id: 'ruta.cobros', label: 'Cobros (pestaña principal)', group: 'Vistas', description: 'Tab/atajo "Cobros"' },
  ...
  { id: 'ruta.carga', label: 'Mi carga', group: 'Vistas', description: 'Opción "Mi carga" (menú Más)' },
  { id: 'ruta.descarga', label: 'Liquidar / Descargar ruta', group: 'Vistas', description: 'Opción del menú "Más"' },
  // Acciones de venta
  ...
  { id: 'ruta.cambiar_precio', label: 'Cambiar precio manual en línea', group: 'Ventas', description: 'Permite escribir un precio manual distinto al de la tarifa' },
  { id: 'ruta.cambiar_lista_precio', label: 'Cambiar lista de precios en línea', group: 'Ventas', description: 'Permite elegir otra lista de precios distinta a la asignada al cliente' },
