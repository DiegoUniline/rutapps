...
const WELCOME =
  "¡Hola! Soy **Sofía**, asesora de RutApp 👋 ¿Tienes dudas sobre cómo digitalizar tu distribuidora? Pregúntame lo que quieras.";
    ...
    <>
        ...
        <div className="fixed bottom-24 right-5 z-[60] max-w-[260px] animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          >
            ...
            <p className="text-gray-600 text-[13px] mt-0.5 leading-snug">
              Nuestra agente de IA <span className="font-semibold text-[#0060e8]">Sofía</span> te responde al instante.
            </p>
          </button>
        </div>
      )}
      ...
      {!open && (
        ...
        >
          ...
          <span className="text-sm font-bold whitespace-nowrap">Chat con Sofía</span>
        </button>
      )}
      ...
      {open && (
        <div
          ...
          role="dialog"
          aria-label="Chat con Sofía de RutApp"
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <p className="text-sm font-bold flex items-center gap-1.5">
                  Sofía <Sparkles className="h-3 w-3 text-yellow-300" />
                </p>
                <p className="text-[11px] text-white/80">Asesora RutApp · En línea</p>
              </div>
            </div>
            <button
          ...
          <p className="text-[10px] text-gray-400 text-center pb-2 px-3 bg-white">
            Sofía es una asistente IA. Para soporte humano: WhatsApp +52 1 317 104 5954
          </p>
        </div>
      )}
    </>
