            ...
            <div className="flex flex-col pointer-events-auto">
              <DayPicker
                ...
                classNames={{
                  ...
                  cell: 'h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected])]:bg-primary/15 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md',
